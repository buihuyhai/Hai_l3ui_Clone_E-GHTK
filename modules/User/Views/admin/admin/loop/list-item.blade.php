                ...
                <td class="text-end">
                    <div class="dropdown">
                        ...
                        <ul
                            ...
                            @if(Auth::user()->hasPermissionTo('update_admin'))
                                <li>
                                    @include("User::admin.components.dropdown-items.item-link",
                                        [
                                            "url" => route("user.admin.admin.update", ["id" => $row->id]),
                            ...
                            @endif
                            @if(Auth::user()->hasPermissionTo('lock_admin'))
                                <li>
                                    @include("User::admin.components.dropdown-items.change-lock")
                                </li>
                            @endif
                            @if(Auth::user()->hasPermissionTo('delete_admin'))
                                <li>
