...
(function ($) {
	...
	/*----------------------------------------*/
	// Li's Dropdown Menu
	// Toggle classes on trigger click
	// The Anh Fixed
	$('.ht-setting-trigger, .ht-currency-trigger, .ht-language-trigger, .hm-minicart-trigger, .cw-sub-menu').on('click', function (e) {
		e.preventDefault();
		var $this = $(this);

		// Toggle active class on the clicked trigger
		$this.toggleClass('is-active');

		// Hide siblings with classes based on the trigger clicked
		var relatedContent = $this.siblings('.ht-setting, .ht-currency, .ht-language, .minicart, .cw-sub-menu li');
		relatedContent.toggleClass('d-block');

		// Ensure only the related content of the active trigger is visible
		if ($this.hasClass('is-active')) {
			relatedContent.addClass('d-block');
		} else {
			relatedContent.removeClass('d-block');
		}
	});
	...
	$(document).on('click', function (e) {
		...
		if (!$target.closest('.ht-setting-trigger, .ht-currency-trigger, .ht-language-trigger, .hm-minicart-trigger, .cw-sub-menu').length) {
			// Remove 'd-block' class from all related elements
			$('.ht-setting, .ht-currency, .ht-language, .minicart, .cw-sub-menu li').removeClass('d-block');

			// Remove 'is-active' class from all triggers
			$('.ht-setting-trigger, .ht-currency-trigger, .ht-language-trigger, .hm-minicart-trigger, .cw-sub-menu').removeClass('is-active');
		}
	});
	//End The Anh fixed
	/*----------------------------------------*/
