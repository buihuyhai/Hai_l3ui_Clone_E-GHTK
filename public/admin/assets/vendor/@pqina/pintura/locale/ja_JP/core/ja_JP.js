...
export default {
    ...
    // new status options
    statusImageLoadNone: '画像を待っています',
    statusImageLoadMinSize: '最小画像サイズは {minWidth} &times; {minHeight} です',
    statusImageLoadError: '画像の読み込みエラー',
    statusImageLoadPrepare: '画像を準備中&hellip;',
    statusImageLoadBusy: '画像を読み込んでいます&hellip;',
    statusImageUploadError: '画像のアップロードエラー',
    statusImageUploadBusy: '画像をアップロード中&hellip;',
    statusImageProcessError: '画像の処理エラー',
    statusImageProcessBusy: '画像を処理中&hellip;',
};
