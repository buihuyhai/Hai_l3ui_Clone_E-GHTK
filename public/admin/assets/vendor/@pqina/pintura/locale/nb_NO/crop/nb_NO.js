export default {
    ...
    cropLabelButtonRecenter: 'Senter',
    cropLabelButtonRotateLeft: 'Roter venstre',
    cropLabelButtonRotateRight: 'Roter høyre',
    cropLabelButtonFlipHorizontal: 'Vend horisontalt',
    cropLabelButtonFlipVertical: 'Vend vertikalt',

    cropLabelSelectPreset: 'Klippeform',

    cropLabelCropBoundary: 'Klippegrense',
    cropLabelCropBoundaryEdge: 'Kanten av bildet',
    cropLabelCropBoundaryNone: 'Ingen',

    cropLabelTabRotation: 'Rotasjon',
