...
export default {
    ...
    // new status options
    statusImageLoadNone: 'Venter på bilde',
    statusImageLoadMinSize: 'Minimum bildestørrelse er {minWidth} &times; {minHeight}',
    statusImageLoadError: 'Feil ved lasting av bilde',
    statusImageLoadPrepare: 'Forbereder bilde&hellip;',
    statusImageLoadBusy: 'Laster bilde&hellip;',
    statusImageUploadError: 'Feil ved opplasting av bilde',
    statusImageUploadBusy: 'Laster opp bilde&hellip;',
    statusImageProcessError: 'Feil ved behandling av bilde',
    statusImageProcessBusy: 'Behandler bilde&hellip;',
};
