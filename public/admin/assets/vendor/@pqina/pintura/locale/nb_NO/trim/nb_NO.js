export default {
    ...
    trimLabelMute: 'Stille',
    trimLabelUnmute: 'Aktiver lyd',
    ...
    // overrides
    unitSeconds: ['secund', 'secunder'],
    statusImageLoadNone: 'Venter på media',
    statusImageLoadMinSize: 'Minimum mediestørrelse er {minWidth} &times; {minHeight}',
    statusImageLoadMinDuration: `Minimum videovarighet er {minDuration} {seconds}`,
    statusImageLoadError: 'Feil ved lasting av media',
    statusImageLoadPrepare: 'Forbereder media&hellip;',
    statusImageLoadBusy: 'Laster media&hellip;',
    statusImageUploadError: 'Feil ved opplasting av media',
    statusImageUploadBusy: 'Laster opp media&hellip;',
    statusImageProcessError: 'Feil ved prosessering av media',
    statusImageProcessBusy: 'Prosessering av media&hellip;',

    cropLabelCropBoundaryEdge: 'Kanten av media',
};
