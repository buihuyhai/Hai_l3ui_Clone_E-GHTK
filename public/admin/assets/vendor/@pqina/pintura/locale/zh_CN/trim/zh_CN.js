export default {
    ...
    // overrides
    statusImageLoadNone: '正在等待图像',
    statusImageLoadMinSize: '最小尺寸为{minWidth} &times; {minHeight}',
    statusImageLoadMinDuration: `最短视频时长为 {minDuration} 秒`,
    statusImageLoadError: '加载图像出错',
    statusImageLoadPrepare: '创建预览&hellip;',
    statusImageLoadBusy: '图像加载中&hellip;',
    statusImageUploadError: '上传图像时出错',
    statusImageUploadBusy: 'U正在上传图像&hellip;',
    statusImageProcessError: '处理图像时出错',
    statusImageProcessBusy: '图像处理中&hellip;',
