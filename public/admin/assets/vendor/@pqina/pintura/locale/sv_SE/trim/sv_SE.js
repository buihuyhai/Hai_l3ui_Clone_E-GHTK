export default {
    ...
    // overrides
    unitSeconds: ['sekund', 'sekunder'],
    statusImageLoadNone: 'Väntar på media',
    statusImageLoadMinSize: 'Minimum media storlek är {minWidth} &times; {minHeight}',
    statusImageLoadMinDuration: `Minsta videolängd är {minDuration} {seconds}`,
    statusImageLoadError: 'Fel vid laddning av media',
    statusImageLoadPrepare: 'Förbereder media&hellip;',
    statusImageLoadBusy: 'Laddar media&hellip;',
    statusImageUploadError: 'Fel vid uppladdning av media',
    statusImageUploadBusy: 'Laddar upp media&hellip;',
    statusImageProcessError: 'Fel vid bearbetning av media',
    statusImageProcessBusy: 'Bearbetar media&hellip;',
