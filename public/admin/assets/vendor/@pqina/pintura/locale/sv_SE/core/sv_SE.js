...
export default {
    ...
    // new status options
    statusImageLoadNone: 'Väntar på bild',
    statusImageLoadMinSize: 'Minsta bildstorlek är {minWidth} &times; {minHeight}',
    statusImageLoadError: 'Fel vid laddning av bild',
    statusImageLoadPrepare: 'Förbereder bild&hellip;',
    statusImageLoadBusy: 'Laddar bild&hellip;',
    statusImageUploadError: 'Fel vid uppladdning av bild',
    statusImageUploadBusy: 'Laddar upp bild&hellip;',
    statusImageProcessError: 'Fel vid behandling av bild',
    statusImageProcessBusy: 'Bearbetar bild&hellip;',
};
