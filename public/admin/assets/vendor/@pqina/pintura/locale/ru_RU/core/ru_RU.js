...
export default {
    ...
    // new status options
    statusImageLoadNone: 'Ожидание изображения',
    statusImageLoadMinSize: 'Минимальный размер: {minWidth} &times; {minHeight}',
    statusImageLoadError: 'Ошибка загрузки изображения',
    statusImageLoadPrepare: 'Подготовка образа&hellip;',
    statusImageLoadBusy: 'Загрузка изображения&hellip;',
    statusImageUploadError: 'Ошибка загрузки изображения',
    statusImageUploadBusy: 'Загрузка изображения&hellip;',
    statusImageProcessError: 'Ошибка обработки изображения',
