export default {
    ...
    // overrides
    statusImageLoadNone: 'मीडिया की प्रतीक्षा की जा रही है',
    statusImageLoadMinSize: 'न्यूनतम मीडिया आकार है {minWidth} &times; {minHeight}',
    statusImageLoadMinDuration: `न्यूनतम वीडियो अवधि {minDuration} सेकंड है`,
    statusImageLoadError: 'मीडिया लोड करने में त्रुटि',
    statusImageLoadPrepare: 'मीडिया तैयार कर रहे हैं&hellip;',
    statusImageLoadBusy: 'मीडिया लोड हो रही है&hellip;',
    statusImageUploadError: 'मीडिया अपलोड करते समय त्रुटि हुई',
    statusImageUploadBusy: 'मीडिया अपलोड हो रहा है&hellip;',
    statusImageProcessError: 'मीडिया को प्रोसेस करने में त्रुटि',
    statusImageProcessBusy: 'मीडिया प्रोसेस हो रहा है&hellip;',
