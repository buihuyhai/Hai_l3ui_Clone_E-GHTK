export default {
    ...
    statusImageLoadNone: 'Aguardando mídia',
    statusImageLoadMinSize: 'O tamanho mínimo da mídia é {minWidth} &times; {minHeight}',
    statusImageLoadMinDuration: 'Duração mínima do vídeo é de {minDuration} {seconds}',
    statusImageLoadError: 'Erro ao carregar mídia',
    statusImageLoadPrepare: 'Preparando mídia&hellip;',
    statusImageLoadBusy: 'Carregando mídia&hellip;',
    statusImageUploadError: 'Erro ao enviar mídia',
    statusImageUploadBusy: 'Enviando mídia&hellip;',
    statusImageProcessError: 'Erro ao processar mídia',
    statusImageProcessBusy: 'Processando mídia&hellip;',
