...
export default {
    ...
    // new status options
    statusImageLoadNone: 'Aguardando imagem',
    statusImageLoadMinSize: 'O tamanho mínimo da imagem é {minWidth} &times; {minHeight}',
    statusImageLoadError: 'Erro ao carregar a imagem',
    statusImageLoadPrepare: 'Preparando imagem&hellip;',
    statusImageLoadBusy: 'Carregando imagem&hellip;',
    statusImageUploadError: 'Erro ao enviar imagem',
    statusImageUploadBusy: 'Enviando imagem&hellip;',
    statusImageProcessError: 'Erro ao processar imagem',
    statusImageProcessBusy: 'Processando imagem&hellip;',
};
